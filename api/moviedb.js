...
const trendingMoviesEndpoint = `${apiBaseUrl}/movie/popular?language=en-US&page=1${apiKey}`;
const upcomingMoviesEndpoint = `${apiBaseUrl}/movie/upcoming?language=en-US&page=1${apiKey}`;
const topRatedMoviesEndpoint = `${apiBaseUrl}/movie/top_rated?language=en-US&page=1${apiKey}`;
